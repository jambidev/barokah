...
const Landing: React.FC<LandingProps> = ({ onNavigate }) => {
  ...
  const heroImages = [
    'https://plazait.co.id/wp-content/uploads/2023/10/jasa-service-printer-medan.jpg',
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSq7t6_KV3sgaoK1v8MaiMWl0EC2lJu6oCxggOarYnNhkRZ17KLWhmrXsYd23OUD-jC0TM&usqp=CAU',
    'https://parto.id/asset/foto_produk/servis_head_epson.jpg',
    'https://siplahtelkom.com/public/products/139355/3683641/servis-print-he.1658459879.jpg',
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTL32GAJa_NlgFXbNCjf_QsWXZUoMD8s1dJk6xKipvsDn3aNjyjrcYtN3BUGGt7oy342nQ&usqp=CAU',
    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTbTlB2_Is0JZKlx-CArSG4cU4UsCsBwh0L4HEVybtma3-dBS4npnF_-dzu_GvPrmyt504&usqp=CAU'
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative mt-8 lg:mt-0" data-aos="fade-left" data-aos-delay="300">
              <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-4 sm:p-6 md:p-8 overflow-hidden card-hover-glow">
                <div className="relative h-48 sm:h-64 md:h-80 rounded-lg overflow-hidden shadow-2xl">
                  {/* Images */}
                  <div 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 sm:gap-4 md:gap-6 lg:gap-8 w-full px-4">
            {supportedBrands.map((brand, index) => (
              ...
              >
                <div className="h-12 w-12 sm:h-16 sm:w-16 md:h-20 md:w-20 lg:h-28 lg:w-28 bg-white rounded-lg md:rounded-2xl mx-auto mb-2 sm:mb-3 md:mb-4 lg:mb-6 flex items-center justify-center p-2 sm:p-3 md:p-4 group-hover:scale-110 transition-transform duration-300">
                  <img 
                    src={(() => {
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40"></div>
         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8 lg:gap-12 items-center">
            ...
            {/* YouTube Video */}
            <div className="relative mt-8 lg:mt-0" data-aos="fade-left" data-aos-delay="300">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl md:rounded-2xl p-3 md:p-4 card-hover-glow mx-4">
                <div className="relative w-full h-48 sm:h-64 md:h-80 lg:h-96 rounded-lg overflow-hidden shadow-xl md:shadow-2xl">
                  <iframe
