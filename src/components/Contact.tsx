...
const Contact: React.FC<ContactProps> = ({ onNavigate }) => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      details: ['Senin-Sabtu: 08:00-17:00', 'Minggu: 08:00-16:00'],
        ...
        <div className="mt-8 sm:mt-12 lg:mt-16 bg-white rounded-2xl shadow-lg overflow-hidden card-hover-glow mobile-fade-left" data-aos="fade-up" data-aos-delay="400">
          <div className="p-4 sm:p-6 lg:p-8">
            ...
            <div className="grid lg:grid-cols-2 gap-4 sm:gap-6 lg:gap-8">
              ...
              <div className="rounded-lg h-48 sm:h-56 lg:h-64 overflow-hidden card-hover-subtle" data-aos="fade-left" data-aos-delay="800">
                <iframe
